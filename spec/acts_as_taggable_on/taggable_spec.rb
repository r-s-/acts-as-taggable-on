...
describe "Taggable" do
  ...
  it "should have tags_on" do
    TaggableModel.tags_on(:tags).to_a.should be_empty
  ...
  it "should be able to get all tags on model as whole" do
    ...
    TaggableModel.all_tags.to_a.should_not be_empty
  ...
  describe "NonStandardIdTaggable" do
    ...
    it "should have tags_on" do
      NonStandardIdTaggableModel.tags_on(:tags).to_a.should be_empty
